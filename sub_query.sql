...
SELECT first_name,last_name,gender, AVG(Max_age)
FROM (SELECT first_name,last_name,gender, MIN(age) Min_age, MAX(age) Max_age, COUNT(age) Count_age ,AVG(age) Avg_age
FROM employee_demographics
GROUP BY first_name,last_name,gender) AS Agg_Table
